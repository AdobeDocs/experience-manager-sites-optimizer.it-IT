...
+ Documentazione{#documentation}
  ...
  + [Nozioni di base](/help/documentation/basics.md)
  ...
  + Opportunità{#opportunities}
    ...
    + [Preparazione delle patch del codice](/help/documentation/opportunities/preparing-code-patches.md)
    ...
    + {hide-from-toc}[Problema di accessibilità dei moduli](/help/documentation/opportunities/forms-accessibility-issues.md)
